...
export class ImportQR extends Component {
    ...
    handleBarCodeScanned = ({ type, data }) => {
        ...
        context.updateMostRecentCourseImportedFromQRCode(decodedData.boundary,context.generateControlsFromCoordinates(decodedData.controls),decodedData.courseType);
        } catch (e) {
            console.warn(e);

            Alert.alert(
                "Invalid QR Code",
                "This doesn't seem like a QR Code generated by the Dice-O App.  Try scanning a different QR Code or making your own course.",
                [{
                    text: "Continue",
